      ...
      <div>
        <section className="w-[80%] min-w-[300px] max-w-[400px] mx-auto">
          ...
          <ul className="list-disc mx-auto text-left">
            ...
            <li>Calculate the Theoretical performance for any modern graphics card</li>
            <li>Capable of measuring the FP32(float), Texture rate, Pixel rate and Memory bandwidth performances</li>
          </ul>
        </section>
